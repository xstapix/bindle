  ...
  return (
    <>
      ...
      <div style={{position: 'relative'}}>
        <p className='propertisSearch'>Guests</p>
        <div className='DF_JS_AC'>
          <div
            onClick={handlerGuest}
            className='graySearch color-304659 marginRight cursorP'
            style={{padding: 14}}
            id='guest'>
            {`Abults: ${Adults}`}
          </div>
          <div
            onClick={handlerGuest}
            className='graySearch color-304659 margin-0_2_0 cursorP'
          ...
          <div
            onClick={handlerGuest}
            className='graySearch color-304659  marginLeft cursorP'
            style={{padding: 14}}
            id='guest'>
            {`Rooms: ${Rooms}`}
          </div>
        ...
        <div className={guestActive ? 'S_Active' : 'S_None'}>
          <div className='settingBackground' onClick={handlerGuest}>
            <div className="guestS" onClick={(event) => event.stopPropagation()} style={{bottom: -125, left: 320}}>
              <div className='container'>
                <div className='DF_JS_AC margin-0_0_24'>
                  ...
                  <div className='DF_JS_AC margin-0_0_0_50'>
                    ...
                    <div onClick={() => setAdults(Adults - 1)} className='cursorP BG-3A6AD5 padding-5 DF br_radius-284'>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.75 12.75C5.53333 12.75 5.35417 12.6792 5.2125 12.5375C5.07083 12.3958 5 12.2167 5 12C5 11.7833 5.07083 11.6042 5.2125 11.4625C5.35417 11.3208 5.53333 11.25 5.75 11.25H18.25C18.4667 11.25 18.6458 11.3208 18.7875 11.4625C18.9292 11.6042 19 11.7833 19 12C19 12.2167 18.9292 12.3958 18.7875 12.5375C18.6458 12.6792 18.4667 12.75 18.25 12.75H5.75Z" fill="white"/>
                      </svg>
                    </div>}
                ...
                <div className='DF_JS_AC margin-0_0_24'>
                  ...
                  <div className='DF_JS_AC'>
                    ...
                    <div onClick={() => setChildren(Children - 1)} className='cursorP BG-3A6AD5 padding-5 DF br_radius-284'>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.75 12.75C5.53333 12.75 5.35417 12.6792 5.2125 12.5375C5.07083 12.3958 5 12.2167 5 12C5 11.7833 5.07083 11.6042 5.2125 11.4625C5.35417 11.3208 5.53333 11.25 5.75 11.25H18.25C18.4667 11.25 18.6458 11.3208 18.7875 11.4625C18.9292 11.6042 19 11.7833 19 12C19 12.2167 18.9292 12.3958 18.7875 12.5375C18.6458 12.6792 18.4667 12.75 18.25 12.75H5.75Z" fill="white"/>
                      </svg>
                    </div>}
                ...
                <div className='DF_JS_AC'>
                  ...
                  <div className='DF_JS_AC'>
                    ...
                    <div onClick={() => setRooms(Rooms - 1)} className='cursorP BG-3A6AD5 padding-5 DF br_radius-284'>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.75 12.75C5.53333 12.75 5.35417 12.6792 5.2125 12.5375C5.07083 12.3958 5 12.2167 5 12C5 11.7833 5.07083 11.6042 5.2125 11.4625C5.35417 11.3208 5.53333 11.25 5.75 11.25H18.25C18.4667 11.25 18.6458 11.3208 18.7875 11.4625C18.9292 11.6042 19 11.7833 19 12C19 12.2167 18.9292 12.3958 18.7875 12.5375C18.6458 12.6792 18.4667 12.75 18.25 12.75H5.75Z" fill="white"/>
                      </svg>
                    </div>}
      ...
      : <div onClick={handlerGuest} className='calendar_desk'>
        <div className='DF cursorP' id='guest'>
          <p className='date_text-desk' id='guest'>People</p>
          <svg id='guest' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='color-696F8C cursorP' id='guest'>
          <p id='guest'>Adults: {Adults}</p>
          <p id='guest'>Children: {Children}</p>
          <p id='guest'>Rooms: {Rooms}</p>
        </div>
